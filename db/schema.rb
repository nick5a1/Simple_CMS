...
ActiveRecord::Schema.define(:version => 20120623224903) do
  ...
  add_index "admin_users_pages", ["page_id", "admin_user_id"], :name => "index_admin_users_pages_on_page_id_and_admin_user_id"
